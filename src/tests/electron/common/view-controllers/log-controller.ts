...
export class LogController {
    ...
    constructor(currentContext: string, private mockAdbPath: string, private page: Page) {
    ...
    public async waitForAdbLogToContain(contains: string) {
        ...
        return this.page.waitForFunction(isLogReady, { timeout: DEFAULT_WAIT_FOR_LOG_TIMEOUT_MS });
    }
